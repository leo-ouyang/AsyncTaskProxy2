...
import static leo.android.dx.rop.code.Rop.BRANCH_GOTO;
import static leo.android.dx.rop.code.Rop.BRANCH_NONE;
import static leo.android.dx.rop.code.Rop.BRANCH_RETURN;
import static leo.android.dx.rop.type.Type.BT_BYTE;
import static leo.android.dx.rop.type.Type.BT_CHAR;
import static leo.android.dx.rop.type.Type.BT_INT;
import static leo.android.dx.rop.type.Type.BT_SHORT;
...
import leo.android.dx.rop.code.BasicBlockList;
import leo.android.dx.rop.code.Insn;
import leo.android.dx.rop.code.PlainCstInsn;
import leo.android.dx.rop.code.PlainInsn;
import leo.android.dx.rop.code.RegisterSpecList;
import leo.android.dx.rop.code.Rop;
import leo.android.dx.rop.code.Rops;
import leo.android.dx.rop.code.SourcePosition;
import leo.android.dx.rop.code.ThrowingCstInsn;
import leo.android.dx.rop.code.ThrowingInsn;
import leo.android.dx.rop.cst.CstInteger;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<D> instance, Local<V> source) {
    ...
    private Rop getCastRop(leo.android.dx.rop.type.Type sourceType,
            leo.android.dx.rop.type.Type targetType) {
