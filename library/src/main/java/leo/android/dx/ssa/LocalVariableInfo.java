...
import leo.android.dx.util.MutabilityControl;

/**
 * Container for local variable information for a particular {@link
 * leo.android.dx.ssa.SsaMethod}.
 * Stolen from {@link leo.android.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link leo.android.dx.rop.code.RegisterSpecSet} to use when indicating a block
     ...
     * {@link leo.android.dx.rop.type.TypeBearer} (such as a constant value).
     *
